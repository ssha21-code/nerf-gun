...
// include: C:\Users\suren\AppData\Local\Temp\tmp3hkpk6dz.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'nerf_gun.data';
      var REMOTE_PACKAGE_BASE = 'nerf_gun.data';
...
Module['FS_createPath']("/", "Sounds", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_nerf_gun.data');
      }
      Module['addRunDependency']('datafile_nerf_gun.data');
    ...
    loadPackage({"files": [{"filename": "/Graphics/enemy.png", "start": 0, "end": 64454}, {"filename": "/Graphics/enemy_shooting.png", "start": 64454, "end": 133078}, {"filename": "/Graphics/hero.png", "start": 133078, "end": 201135}, {"filename": "/Graphics/hero_shooting.png", "start": 201135, "end": 275457}, {"filename": "/Graphics/land.png", "start": 275457, "end": 1524874}, {"filename": "/Sounds/gunshot.mp3", "start": 1524874, "end": 1531603}], "remote_package_size": 1531603});

  })();

// end include: C:\Users\suren\AppData\Local\Temp\tmp3hkpk6dz.js
// include: C:\Users\suren\AppData\Local\Temp\tmp4nznrit3.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\suren\AppData\Local\Temp\tmp4nznrit3.js
// include: C:\Users\suren\AppData\Local\Temp\tmp0ayk5imc.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\suren\AppData\Local\Temp\tmp0ayk5imc.js
...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('nerf_gun.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('nerf_gun.wasm', import.meta.url).href;
}
...
var ASM_CONSTS = {
  2162192: () => { if (document.fullscreenElement) return 1; },  
 2162238: () => { return Module.canvas.width; },  
 2162270: () => { return parseInt(Module.canvas.style.width); },  
 2162318: () => { document.exitFullscreen(); },  
 2162345: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2162418: () => { if (document.fullscreenElement) return 1; },  
 2162464: () => { return Module.canvas.width; },  
 2162496: () => { return screen.width; },  
 2162521: () => { document.exitFullscreen(); },  
 2162548: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2162681: () => { return window.innerWidth; },  
 2162707: () => { return window.innerHeight; },  
 2162734: () => { if (document.fullscreenElement) return 1; },  
 2162780: () => { return Module.canvas.width; },  
 2162812: () => { return parseInt(Module.canvas.style.width); },  
 2162860: () => { if (document.fullscreenElement) return 1; },  
 2162906: () => { return Module.canvas.width; },  
 2162938: () => { return screen.width; },  
 2162963: () => { return window.innerWidth; },  
 2162989: () => { return window.innerHeight; },  
 2163016: () => { if (document.fullscreenElement) return 1; },  
 2163062: () => { return Module.canvas.width; },  
 2163094: () => { return screen.width; },  
 2163119: () => { document.exitFullscreen(); },  
 2163146: () => { if (document.fullscreenElement) return 1; },  
 2163192: () => { return Module.canvas.width; },  
 2163224: () => { return parseInt(Module.canvas.style.width); },  
 2163272: () => { document.exitFullscreen(); },  
 2163299: ($0) => { Module.canvas.style.opacity = $0; },  
 2163337: () => { return screen.width; },  
 2163362: () => { return screen.height; },  
 2163388: () => { return window.screenX; },  
 2163415: () => { return window.screenY; },  
 2163442: () => { return window.devicePixelRatio; },  
 2163478: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2163531: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 2163582: () => { Module.canvas.style.cursor = 'none'; },  
 2163619: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2163875: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 2163926: () => { if (document.pointerLockElement) return 1; },  
 2163973: () => { if (document.fullscreenElement) return 1; },  
 2164019: () => { return window.innerWidth; },  
 2164045: () => { return window.innerHeight; },  
 2164072: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 2166250: () => { if (typeof(window.miniaudio) !== 'undefined') { miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 2166540: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 2166644: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 2166815: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 2169692: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 2169765: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 2170165: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 2170215: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 2170354: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; }
};
